...
@author: wshalaby
"""
#strange D:\data_test\20newsgroup\20NG_Source\rec.motorcycles\105215
...
#esa_spark_resolved
#nohup spark-submit --driver-memory 13g --executor-memory 13g concept_classification.py >& esa_spark_resolved.out &
#autos.motors
#conc --> ok
#nohup spark-submit --driver-memory 13g --executor-memory 13g concept_classification.autos.motors.conc.py >& esa_spark_resolved.conc.autos.motors.out &
#cat samples-out-concepts-conc-allnorm-0.85.esa.resolved.autos.motors.txt|grep -P 'rec.autos\t2\trec.autos\t2'|wc -l
#975
#cat samples-out-concepts-conc-allnorm-0.85.esa.resolved.autos.motors.txt|grep -P 'rec.autos\t2\trec.motorcycles\t1'|wc -l
#9
#cat samples-out-concepts-conc-allnorm-0.85.esa.resolved.autos.motors.txt|grep -P 'rec.motorcycles\t1\trec.motorcycles\t1'|wc -l
#458
#cat samples-out-concepts-conc-allnorm-0.85.esa.resolved.autos.motors.txt|grep -P 'rec.motorcycles\t1\trec.autos\t2'|wc -l
#513
#(975+458)/((975+9)+(458+513))
#0.732992327365729
#(975+458)/(2000.0)
#0.7165
...
#autos.elecs
#conc --> ok
#nohup spark-submit --driver-memory 13g --executor-memory 13g concept_classification.autos.elecs.conc.py >& esa_spark_resolved.conc.autos.elecs.out &
#cat samples-out-concepts-conc-allnorm-0.85.esa.resolved.autos.elecs.txt|grep -P 'rec.autos\t2\trec.autos\t2'|wc -l
#904
#cat samples-out-concepts-conc-allnorm-0.85.esa.resolved.autos.elecs.txt|grep -P 'rec.autos\t2\tsci.electronics\t1'|wc -l
#84
#cat samples-out-concepts-conc-allnorm-0.85.esa.resolved.autos.elecs.txt|grep -P 'sci.electronics\t1\tsci.electronics\t1'|wc -l
#956
#cat samples-out-concepts-conc-allnorm-0.85.esa.resolved.autos.elecs.txt|grep -P 'sci.electronics\t1\trec.autos\t2'|wc -l
#39
#(904+956)/((904+84)+(956+39))
#0.9379727685325264
#(904+956)/1999.0
#0.9304652326163082
...
#autos.elecs
#anno --> ok
#nohup spark-submit --driver-memory 13g --executor-memory 13g --py-files commons.py,munkres.py concept_classification.autos.motors.anno.py >& hungarian_spark_resolved_cosines.autos.motors.out &
...
# anno 0.65 --> not yet
#nohup spark-submit --driver-memory 13g --executor-memory 13g --py-files commons.py,munkres.py concept_classification.autos.elecs.anno.py >& hungarian_spark_resolved_cosines.autos.elecs.65.out &

#conc --> ok
#nohup spark-submit --driver-memory 13g --executor-memory 13g --py-files commons.py,munkres.py concept_classification.autos.elecs.conc.py >& hungarian_spark_resolved_cosines.autos.elecs.conc.out &
#cat samples-out-concepts-conc-allnorm-0.85.hung.resolved.autos.elecs.txt|grep -P 'rec.autos\t2\trec.autos\t2'|wc -l
#907
#cat samples-out-concepts-conc-allnorm-0.85.hung.resolved.autos.elecs.txt|grep -P 'rec.autos\t2\tsci.electronics\t1'|wc -l
#90
#cat samples-out-concepts-conc-allnorm-0.85.hung.resolved.autos.elecs.txt|grep -P 'sci.electronics\t1\tsci.electronics\t1'|wc -l
#971
#cat samples-out-concepts-conc-allnorm-0.85.hung.resolved.autos.elecs.txt|grep -P 'sci.electronics\t1\trec.autos\t2'|wc -l
#27
#(907+971)/((907+90)+(971+27))
#0.9413533834586466
#(907+971)/1999.0
#0.9394697348674337
...
# anno 0.65 --> not yet
#nohup spark-submit --driver-memory 13g --executor-memory 13g --py-files commons.py,munkres.py concept_classification.autos.motors.anno.py >& hungarian_spark_resolved_cosines.autos.motors.65.out &

#conc
#nohup spark-submit --driver-memory 13g --executor-memory 13g --py-files commons.py,munkres.py concept_classification.autos.motors.conc.py >& hungarian_spark_resolved_cosines.autos.motors.conc.out &

#54494_sci.electronics
...
if mode not in ('spark_concepts','spark_anno','spark_resolve_concepts','spark_concept_vectors','spark_anno_vectors','spark_concept_vectors_cosines','max_multi_thread_resolved_cosines','hungarian_multi_thread_resolved_cosines','hungarian_spark_resolved_cosines','esa_spark_resolved'):
    import gensim
...
if mode in ('esa_spark_resolved'):
    #concepts
    #175
    topics_inpath = '/home/walid/work/github/semantic_searcher/tree.20newsgroups.simple.esa.concepts.newrefine.leaves.500.resolved'
    samples_inpath = '/home/walid/work/github/semantic_searcher/20newsgroups.simple.esa.concepts.500.resolved'
    output_path = '/home/walid/work/github/semantic_searcher/python/samples-out-concepts-conc-allnorm-0.0.resolved.esa.txt'
    ...
    samples_inpath = '/media/wshalaby/b667e28e-5e90-4884-8810-5d897c9e56ce/work/github/semantic_searcher/20newsgroups.simple.esa.concepts.500.resolved'
    output_path = '/media/wshalaby/b667e28e-5e90-4884-8810-5d897c9e56ce/work/github/semantic_searcher/samples-out-concepts-conc-allnorm-0.0.resolved.esa.txt'

    #urc
    #cosines_inpath = '/scratch/wshalaby/doc2vec/concept_classification_cosines.txt.2recs'
    topics_inpath = '/scratch/wshalaby/doc2vec/tree.20newsgroups.simple.esa.concepts.newrefine.leaves.500.resolved.autos.motors'
    topics_inpath = '/scratch/wshalaby/doc2vec/tree.20newsgroups.simple.esa.concepts.newrefine.leaves.500.resolved.autos.elecs'
    topics_inpath = '/scratch/wshalaby/doc2vec/tree.20newsgroups.simple.esa.concepts.newrefine.leaves.500.resolved'
    samples_inpath = '/scratch/wshalaby/doc2vec/20newsgroups.simple.esa.concepts.500.resolved.autos.motors'
    samples_inpath = '/scratch/wshalaby/doc2vec/20newsgroups.simple.esa.concepts.500.resolved.autos.elecs'
    samples_inpath = '/scratch/wshalaby/doc2vec/20newsgroups.simple.esa.concepts.500.resolved'
    
    samples_inpath_hdfs = "20newsgroups.simple.esa.concepts.500.resolved.autos.elecs"
    samples_inpath_hdfs = "20newsgroups.simple.esa.concepts.500.resolved.autos.motors"
    ...
    output_path = '/scratch/wshalaby/doc2vec/samples-out-concepts-conc-allnorm-0.0.resolved.esa.txt'
    output_path_hdfs = 'samples-out-concepts-conc-allnorm-0.85.esa.resolved.autos.elecs.txt'
    output_path_hdfs = 'samples-out-concepts-conc-allnorm-0.85.esa.resolved.autos.motors.txt'
    output_path_hdfs = 'samples-out-concepts-conc-allnorm-0.85.esa.resolved.txt'
    ...
    output_path = '/media/wshalaby/b667e28e-5e90-4884-8810-5d897c9e56ce/work/github/semantic_searcher/samples-out-anno-conc-allnorm-0.0.resolved.esa.txt'
    ...
    output_path = '/home/walid/work/github/semantic_searcher/python/samples-out-anno-conc-allnorm-0.0.resolved.esa.txt'
    ...
    samples_inpath = '/scratch/wshalaby/doc2vec/20newsgroups.simple.esa.concepts.500.anno.resolved.autos.motors'
    samples_inpath = '/scratch/wshalaby/doc2vec/20newsgroups.simple.esa.concepts.500.anno.resolved.autos.elecs'
    ...
    output_path = '/scratch/wshalaby/doc2vec/samples-out-anno-conc-allnorm-0.0.resolved.esa.txt'
    output_path_hdfs = 'samples-out-concepts-conc-allnorm-0.85.esa.anno.resolved.autos.elecs.txt'
    output_path_hdfs = 'samples-out-concepts-conc-allnorm-0.85.esa.anno.resolved.autos.motors.txt'
    output_path_hdfs = 'samples-out-concepts-conc-allnorm-0.85.esa.anno.resolved.autos.elecs.1rec.txt'
    output_path_hdfs = 'samples-out-concepts-conc-allnorm-0.85.esa.anno.resolved.1rec.txt'
    output_path_hdfs = 'samples-out-concepts-conc-allnorm-0.85.esa.anno.resolved.txt'
...
if mode in ('max_multi_thread_resolved_cosines','hungarian_multi_thread_resolved_cosines','hungarian_spark_resolved_cosines'):
    ...
    output_path_hdfs = 'samples-out-concepts-conc-allnorm-0.85.hung.resolved.autos.elecs.txt'
    output_path_hdfs = 'samples-out-concepts-conc-allnorm-0.85.hung.resolved.autos.motors.txt'
    ...
    output_path_hdfs = 'samples-out-concepts-conc-allnorm-0.85.hung.anno.resolved.txt'
    ...
    if mode=='max_multi_thread_resolved_cosines':
        ...
        from commons import load_cosines_sparse
        #anno
        cosines_inpath = 'concept_classification_anno_cosines.0.85.txt'
        #concepts
        cosines_inpath = 'concept_classification_cosines.0.85.txt'
...
if mode=='spark_resolve_concepts':
    ...
    topics_inpath_hdfs = "tree.20newsgroups.simple.esa.concepts.newrefine.leaves.500.sale"
    topics_inpath_hdfs = "tree.20newsgroups.simple.esa.concepts.newrefine.leaves.500"
    topics_inpath_hdfs = "tree.20newsgroups.simple.esa.concepts.newrefine.leaves.500"
    topics_inpath_hdfs = "tree.20newsgroups.simple.esa.concepts.newrefine.supers.500"
    topics_inpath_hdfs = "tree.20newsgroups.simple.esa.concepts.newrefine.leaves.500.seealsoasso.uniq.1.0.5.1.accum.augm.seealso_asso.500"
    topics_inpath_hdfs = "tree.20newsgroups.simple.esa.concepts.newrefine.supers.500.seealsoasso.uniq.1.0.5.1.accum.augm.seealso_asso.500"
    
    samples_inpath_hdfs = "20newsgroups.simple.esa.concepts.500.10recs"
    samples_inpath_hdfs = "20newsgroups.simple.esa.concepts.500.sale"    
    samples_inpath_hdfs = "20newsgroups.simple.esa.concepts.500"
    samples_inpath_hdfs = "20newsgroups.simple.esa.concepts.500.seealsoasso.uniq.1.0.5.1.accum.augm.seealso_asso.500"
    ...
    topics_outpath_hdfs = "tree.20newsgroups.simple.esa.concepts.newrefine.leaves.500.subnewmap.resolved"
    topics_notfound_outpath_hdfs = "tree.20newsgroups.simple.esa.concepts.newrefine.leaves.500.subnewmap.notfound"
    ...
    samples_outpath_hdfs = "20newsgroups.simple.esa.concepts.500.subnewmap.resolved"
    samples_notfound_outpath_hdfs = "20newsgroups.simple.esa.concepts.500.subnewmap.notfound"
    
    #anno
    topics_outpath_hdfs = "tree.20newsgroups.simple.esa.concepts.newrefine.leaves.500.anno.resolved.3recs"
    topics_outpath_hdfs = "tree.20newsgroups.simple.esa.concepts.newrefine.leaves.500.anno.resolved.sale"
    topics_notfound_outpath_hdfs = "tree.20newsgroups.simple.esa.concepts.newrefine.leaves.500.anno.notfound.sale"
    
    topics_outpath_hdfs = "tree.20newsgroups.simple.esa.concepts.newrefine.leaves.500.anno.seealsoasso.uniq.1.0.5.1.accum.augm.seealso_asso.500.resolved"
    topics_notfound_outpath_hdfs = "tree.20newsgroups.simple.esa.concepts.newrefine.leaves.500.anno.seealsoasso.uniq.1.0.5.1.accum.augm.seealso_asso.500.notfound"
    
    topics_outpath_hdfs = "tree.20newsgroups.simple.esa.concepts.newrefine.leaves.10.anno.resolved"
    topics_notfound_outpath_hdfs = "tree.20newsgroups.simple.esa.concepts.newrefine.leaves.10.anno.notfound"
    ...
    topics_outpath_hdfs = "tree.20newsgroups.simple.esa.concepts.newrefine.leaves.500.anno.seealsoasso.uniq.1.0.5.1.accum.augm.seealso_asso.500.newmap.resolved"
    topics_notfound_outpath_hdfs = "tree.20newsgroups.simple.esa.concepts.newrefine.leaves.500.anno.seealsoasso.uniq.1.0.5.1.accum.augm.seealso_asso.500.newmap.notfound"
    
    topics_notfound_outpath_hdfs = "tree.20newsgroups.simple.esa.concepts.newrefine.leaves.500.anno.subnewmap.notfound"
    topics_outpath_hdfs = "tree.20newsgroups.simple.esa.concepts.newrefine.leaves.500.anno.subnewmap.resolved"
    
    topics_outpath_hdfs = "tree.20newsgroups.simple.esa.concepts.newrefine.leaves.20.anno.resolved"
    topics_notfound_outpath_hdfs = "tree.20newsgroups.simple.esa.concepts.newrefine.leaves.20.anno.notfound"
    
    topics_notfound_outpath_hdfs = "tree.20newsgroups.simple.esa.concepts.newrefine.leaves.500.anno.subnewmap.v2.notfound"
    topics_outpath_hdfs = "tree.20newsgroups.simple.esa.concepts.newrefine.leaves.500.anno.subnewmap.v2.resolved"
    
    topics_notfound_outpath_hdfs = "tree.20newsgroups.simple.esa.concepts.newrefine.supers.500.anno.subnewmap.v2.notfound"
    topics_outpath_hdfs = "tree.20newsgroups.simple.esa.concepts.newrefine.supers.500.anno.subnewmap.v2.resolved"
    
    topics_outpath_hdfs = "tree.20newsgroups.simple.esa.concepts.newrefine.leaves.500.anno.subnewmap.v2.seealsoasso.uniq.1.0.5.1.accum.augm.seealso_asso.500.resolved"
    topics_notfound_outpath_hdfs = "tree.20newsgroups.simple.esa.concepts.newrefine.leaves.500.anno.subnewmap.v2.seealsoasso.uniq.1.0.5.1.accum.augm.seealso_asso.500.notfound"
    
    topics_outpath_hdfs = "tree.20newsgroups.simple.esa.concepts.newrefine.supers.500.anno.subnewmap.v2.seealsoasso.uniq.1.0.5.1.accum.augm.seealso_asso.500.resolved"
    topics_notfound_outpath_hdfs = "tree.20newsgroups.simple.esa.concepts.newrefine.supers.500.anno.subnewmap.v2.seealsoasso.uniq.1.0.5.1.accum.augm.seealso_asso.500.notfound"
    
    titles_path = "/scratch/wshalaby/doc2vec/titles_redirects_ids_anno.csv"
        
    samples_outpath_hdfs = "20newsgroups.simple.esa.concepts.500.anno.resolved.sale"
    samples_notfound_outpath_hdfs = "20newsgroups.simple.esa.concepts.500.anno.notfound.sale"

    samples_outpath_hdfs = "20newsgroups.simple.esa.concepts.500.anno.seealsoasso.uniq.1.0.5.1.accum.augm.seealso_asso.500.resolved"
    samples_notfound_outpath_hdfs = "20newsgroups.simple.esa.concepts.500.anno.seealsoasso.uniq.1.0.5.1.accum.augm.seealso_asso.500.notfound"
    
    samples_outpath_hdfs = "20newsgroups.simple.esa.concepts.10.anno.resolved"
    samples_notfound_outpath_hdfs = "20newsgroups.simple.esa.concepts.10.anno.notfound"
    ...
    samples_outpath_hdfs = "20newsgroups.simple.esa.concepts.500.anno.seealsoasso.uniq.1.0.5.1.accum.augm.seealso_asso.500.newmap.resolved"
    samples_notfound_outpath_hdfs = "20newsgroups.simple.esa.concepts.500.anno.seealsoasso.uniq.1.0.5.1.accum.augm.seealso_asso.500.newmap.notfound"

    samples_outpath_hdfs = "20newsgroups.simple.esa.concepts.500.anno.subnewmap.resolved"
    samples_notfound_outpath_hdfs = "20newsgroups.simple.esa.concepts.500.anno.subnewmap.notfound"
    
    samples_outpath_hdfs = "20newsgroups.simple.esa.concepts.20.anno.resolved"
    samples_notfound_outpath_hdfs = "20newsgroups.simple.esa.concepts.20.anno.notfound"
    
    samples_outpath_hdfs = "20newsgroups.simple.esa.concepts.500.anno.subnewmap.v2.resolved"
    samples_notfound_outpath_hdfs = "20newsgroups.simple.esa.concepts.500.anno.subnewmap.v2.notfound"

    samples_outpath_hdfs = "20newsgroups.simple.esa.concepts.500.anno.subnewmap.v2.seealsoasso.uniq.1.0.5.1.accum.augm.seealso_asso.500.resolved"
    samples_notfound_outpath_hdfs = "20newsgroups.simple.esa.concepts.500.anno.subnewmap.v2.seealsoasso.uniq.1.0.5.1.accum.augm.seealso_asso.500.notfound"    
...
def resolve_esa_concepts_line(line):
    global titlesBC, redirectsBC, skipgram_esa_mappings_dicBC, vec_dim
    topic_name = line[0:line.rfind('\t')]    
    topic_vector = line[line.rfind('\t')+1:]

    # extract class name
    class_name = topic_name[0:topic_name.find('\t')]
    if class_name.find('\\')!=-1: # sample
        tokens = class_name.split('\\')
        class_name = tokens[len(tokens)-2]
    ...
    if vec_dim>0: # extract only top vec_dim concepts
        weights = []
        for concept in topic_vector.split(';'):
            if len(concept)>0:
                tokens = concept.split(',')
                weights.append(float(tokens[1]))
        threshold_weight = sorted(weights, reverse=True)[vec_dim-1]

    for concept in topic_vector.split(';'):
        if len(concept)>0:
            tokens = concept.split(',')            
            org_concept_name = tokens[0]            
            # @wshalaby...TODO unicode
            if isinstance(org_concept_name,unicode)==True:
                org_concept_name = org_concept_name.encode('utf-8')
            concept_weight = tokens[1]            
            if float(concept_weight)<threshold_weight:
                continue
            try:
                concept_name = skipgram_esa_mappings_dicBC.value[org_concept_name]
            except:
                concept_name = org_concept_name                
            # @wshalaby...TODO unicode
            if isinstance(concept_name,str)==True:
                concept_name = concept_name.decode('utf-8')            
            # look up concept id
            try:
                if mode=='spark_anno': # anno titles
                    concept_id = titlesBC.value[concept_name]
                ...
                #print(concept_name+'...not found')
                #notfound_titles.append(('NOT_-_FOUND',class_name+'\t'+org_concept_name))
                # @wshalaby...TODO unicode
                notfound_titles.append(('NOT_-_FOUND',class_name+'\t'+org_concept_name.decode('utf-8')))                
...
def get_hungarian_similarity_resolved_cosines(line):
    ...
    for k,v in topics.items(): # loop on topics
        ...
        topic_accum_vector = v[0]
        if len(topic_accum_vector)<len(accum_vector):
            print(os.linesep+'WARNING...'+sample_info.sample_name+str(len(accum_vector))+k+str(len(topic_accum_vector))+os.linesep)

        cost_matrix = np.zeros((len(accum_vector),len(topic_accum_vector)))#[[0.0 for i in range(len(topic_accum_vector))] for j in range(len(accum_vector))]
        print(os.linesep+sample_info.sample_name+'\t'+k+'\t'+'MAT_DIM\t'+str(cost_matrix.shape)+os.linesep)
        ...
        for i,(sample_weight,concept_name) in enumerate(accum_vector): # loop on each concept in sample
            ...
            for pair in topic_accum_vector:
                if concept_name==pair[1]:
                    exact_found = True                    
                    print(os.linesep+sample_info.sample_name+'\t'+concept_name+'...exact match'+os.linesep)
            ...
            if exact_found==False:
                for j,(topic_weight,topic_name) in enumerate(topic_accum_vector): # v is topic accum_vector in the format (vector,weight)                    
                    if topic_name in topic_titles and concept_name in titles_cosines and topic_titles[topic_name] in titles_cosines[concept_name]:
                        cost_matrix[i][j] = 1.0 - titles_cosines[concept_name][topic_titles[topic_name]]
                        valid_row = True
                        valid_topic_titles.add(j)
                    else:
                        cost_matrix[i][j] = 1.0

            if valid_row==True: # if false then all similarities are 0s or below threshold for this sample title with topic titles
                valid_sample_titles.append(i)                                
            #else:
            #    result += 'ZERO similarities...'+os.linesep
            #    #result.append(['ZERO similarities...',os.linesep])
                
        if len(valid_sample_titles)>0:
            valid_sample_titles_arr = np.array(valid_sample_titles)
            valid_topic_titles_arr = np.array(list(valid_topic_titles))
            #valid_cost_matrix = [cost_matrix[i] for i in valid_sample_titles]
            valid_cost_matrix = cost_matrix[valid_sample_titles_arr[:,None],valid_topic_titles_arr].tolist()
            print(os.linesep+sample_info.sample_name+'\t'+k+'\t'+'MAT_NEW_DIM\t('+str(len(valid_cost_matrix))+','+str(len(valid_cost_matrix[0]))+')'+os.linesep)
            valid_accum_vector = [accum_vector[i] for i in valid_sample_titles]
            m = Munkres()
...
def get_esa_similarity_resolved_spark(line):
...
def get_hungarian_similarity_resolved_cosines_spark(line):
    ...
    for k,v in topicsBC.value.items(): # loop on topics
        ...
        result += sample_info.sample_name+'\t'+k+'\t'+'MAT_DIM\t'+str(cost_matrix.shape)+os.linesep
        # we need to discard all rows in the cost matrix whose elements are all 1s. 
        # this means these the similarities between these sample titles and all topic titles are zeros
        # so no need to include them in the cost matrix for efficiency
        # we also don't need to include in the cost matrix a sample title which has an exact match with a topic title
...
def main():
    ...
    if mode!='cosine' and mode!='test' and mode!='check_file':
        ...
        if mode=='max_multi_thread_resolved_cosines':
            ...
            titles_cosines, topic_titles = load_cosines_sparse(cosines_inpath)
            #titles_cosines, topic_titles = load_cosines(cosines_inpath, min_cosine=0.85)
            print("loaded "+strftime("%Y-%m-%d %H:%M:%S", gmtime()))
        elif mode not in ('hungarian_spark_resolved_cosines','esa_spark_resolved'):
    ...
    if mode=='cosine':
        ...
        with open(samples_inpath,'r') as samples_file:
            ...
            for line in samples_file:
                ...
                if len(line)>0:
                    ...
                    if len(in_records)%200==0:#(multiprocessing.cpu_count()-1)==0:
                        p = Pool(multiprocessing.cpu_count()-1)
                        #samples_info = p.map(get_hungarian_similarity_resolved_cosines, in_records)
                        p.map(get_hungarian_similarity_resolved_cosines, in_records)
                        p.close()
                        #p.join()
                        #write_sims(samples_info)
                        in_records = []
    ...
    elif mode=='esa_spark_resolved':
        from pyspark import SparkContext
        sc = SparkContext(appName="concept classification- esa resolved")
        ...
        print("processing samples")
        samples = sc.textFile(samples_inpath_hdfs)
        results = samples.flatMap(lambda x : get_esa_similarity_resolved_spark(x)).filter(lambda line: line is not None)
        os.system('hdfs dfs -rm -r '+output_path_hdfs)
        results.saveAsTextFile(output_path_hdfs)
        ...
        #print('broadcasting vec_dim ('+str(vec_dim)+')')
        #vec_dimBC = sc.broadcast(vec_dim)
        #print('vec_dim broadcasted')
        ...
        if topics_inpath_hdfs!="":
            ...
            topics_titles.filter(lambda line: line[0]=='NOT_-_FOUND').map(lambda pair: pair[1]).saveAsTextFile(topics_notfound_outpath_hdfs)
        ...
        if samples_inpath_hdfs!="":
            ...
            samples_titles.filter(lambda line: line[0]=='NOT_-_FOUND').map(lambda pair: pair[1]).saveAsTextFile(samples_notfound_outpath_hdfs)
